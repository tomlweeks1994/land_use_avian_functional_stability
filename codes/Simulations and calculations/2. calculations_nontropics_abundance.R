...
results_list <- readRDS("data/Tropics & non-tropics/simulations_abundance_nontropics.rds") 
...
write.csv(analysis_data, "data/Main/nontropics_all_results_abundance.csv")

...
results_list <- readRDS("Datasets/Aug2022/Omnivores/results_list_TPDs_trait_weighted_omnivores.rds") 
...
write.csv(analysis_data, "Datasets/Aug2022/Omnivores/omniv_resistance_trait.csv")

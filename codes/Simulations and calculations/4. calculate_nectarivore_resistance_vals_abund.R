...
results_list <- readRDS("Datasets/Aug2022/Nectarivores/results_list_TPDs_abundance_weighted_nectarivores.rds") 

diversity <- readRDS("Datasets/Aug2022/Nectarivores/diversity_combined_sites_Aug2022_nect.rds")
...
write.csv(analysis_data, "Datasets/Aug2022/Nectarivores/nectariv_resistance_abundance.csv")

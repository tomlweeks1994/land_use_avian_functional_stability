...
diversity <- readRDS("Datasets/Frugivore/diversity_combined_sites_newest_frugivore.rds")
com_matrix_all <- read.csv("Datasets/Frugivore/com_matrix_all_combined_studies_newest_frugivore.csv")
...
effect_trait_matrix <- read.csv("Datasets/Frugivore/PCA_and_diet_data_new_frugivore.csv")
...
response_trait_matrix <- read.csv("Datasets/Aug2022/Frugivores/response_trait_matrix_frug_Aug2022.csv")
...
saveRDS(study_list_all, "Datasets/Aug2022/Frugivores/results_list_TPDs_abundance_weighted_frugivores.rds")

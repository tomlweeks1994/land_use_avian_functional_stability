...
results_list <- readRDS("Datasets/Aug2022/Frugivores/results_list_TPDs_abundance_weighted_frugivores.rds") 

diversity <- readRDS("Datasets/Aug2022/Frugivores/diversity_combined_sites_Aug2022_frugs.rds")
...
write.csv(analysis_data, "Datasets/Aug2022/Frugivores/frug_resistance_abundance.csv")

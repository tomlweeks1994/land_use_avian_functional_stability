...
results_list <- readRDS("data/Invertivores/results_list_TPDs_abundance_weighted_invertivores.rds") 
...
write.csv(analysis_data, "data/Invertivores/invertiv_all_results_abundance.csv")

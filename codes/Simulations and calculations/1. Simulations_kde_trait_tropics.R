...
effect_trait_matrix <- read.csv("data/Tropics & non-tropics/PCA_and_diet_data_tropics_Aug2022.csv")
...
saveRDS(study_list_all, "data/Tropics & non-tropics/simulations_trait_tropics.rds")

...
results_list <- readRDS("data/Frugivores/results_list_TPDs_abundance_weighted_frugivores.rds") 
...
write.csv(analysis_data, "data/Frugivores/frug_all_results_abundance.csv")

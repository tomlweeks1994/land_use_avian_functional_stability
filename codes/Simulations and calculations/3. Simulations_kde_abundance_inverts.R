...
com_matrix_all <- read.csv("Datasets/Aug2022/Invertivores/com_matrix_all_combined_studies_inv_Aug2022.csv")
...
effect_trait_matrix <- read.csv("Datasets/Aug2022/Invertivores/PCA_and_diet_data_Aug2022_inv.csv")
...
response_trait_matrix <- read.csv("Datasets/Aug2022/Invertivores/response_trait_matrix_inv_Aug2022.csv")
...
saveRDS(study_list_all, "Datasets/Aug2022/Invertivores/results_list_TPDs_abundance_weighted_invertivores.rds")

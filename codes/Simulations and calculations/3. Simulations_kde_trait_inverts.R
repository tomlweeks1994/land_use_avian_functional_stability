...
diversity <- readRDS("Datasets/diversity_combined_sites_newest_inv.rds")
com_matrix_all <- read.csv("Datasets/Invertivore/com_matrix_all_combined_studies_newest_invertivore.csv")
...
effect_trait_matrix <- read.csv("Datasets/Invertivore/PCA_and_diet_data_new_invertivore.csv")
...
for(i in c(1:33, 35:length(studies))) {
...
saveRDS(study_list_all, "Datasets/Aug2022/Invertivores/results_list_TPDs_trait_weighted_invertivores.rds")

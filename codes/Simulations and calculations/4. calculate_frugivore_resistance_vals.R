...
results_list <- readRDS("Datasets/Aug2022/Frugivores/results_list_TPDs_trait_weighted_frugivores.rds") 
...
write.csv(analysis_data, "Datasets/Aug2022/Frugivores/frug_resistance_trait.csv")

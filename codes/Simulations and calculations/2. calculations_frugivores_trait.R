...
results_list <- readRDS("data/Frugivores/results_list_TPDs_trait_weighted_frugivores.rds") 
...
write.csv(analysis_data, "data/Frugivores/frug_all_results_trait.csv")

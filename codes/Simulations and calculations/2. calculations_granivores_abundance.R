...
results_list <- readRDS("data/Granivores/results_list_TPDs_abundance_weighted_granivores.rds") 
...
write.csv(analysis_data, "data/Granivores/graniv_all_results_abundance.csv")

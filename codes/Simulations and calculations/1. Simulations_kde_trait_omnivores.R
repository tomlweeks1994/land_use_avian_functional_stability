...
com_matrix_all <- read.csv("data/Omnivores/com_matrix_all_combined_studies_omnivores_Aug2022.csv")
...
effect_trait_matrix <- read.csv("data/Omnivores/PCA_and_diet_data_Aug2022_omnivores.csv")
...
response_trait_matrix <- read.csv("data/Omnivores/response_trait_matrix_omnivores_Aug2022.csv")
...
saveRDS(study_list_all, "data/Omnivores/results_list_TPDs_trait_weighted_omnivores.rds")

...
results_list <- readRDS("Datasets/Aug2022/Granivores/results_list_TPDs_abundance_weighted_granivores.rds") 

diversity <- readRDS("Datasets/Aug2022/Granivores/diversity_combined_sites_Aug2022_graniv.rds")
...
write.csv(analysis_data, "Datasets/Aug2022/Granivores/graniv_resistance_abundance.csv")

...
diversity <- diversity %>% filter(diversity$Trophic_niche == "Nectarivore")


com_matrix_all <- read.csv("Datasets/Aug2022/Nectarivores/com_matrix_all_combined_studies_nectarivores_Aug2022.csv")
...
effect_trait_matrix <- read.csv("Datasets/Aug2022/Nectarivores/PCA_and_diet_data_Aug2022_nectarivores.csv")
...
response_trait_matrix <- read.csv("Datasets/Aug2022/Nectarivores/response_trait_matrix_nectarivores_Aug2022.csv")
...
saveRDS(study_list_all, "Datasets/Aug2022/Nectarivores/results_list_TPDs_abundance_weighted_nectarivores.rds")

...
diversity <- readRDS("data/Frugivores/diversity_combined_sites_Aug2022_frugs.rds")
com_matrix_all <- read.csv("data/Frugivores/com_matrix_all_combined_studies_frug_Aug2022.csv")
...
effect_trait_matrix <- read.csv("data/Frugivores/PCA_and_diet_data_Aug2022_frug.csv")
...
response_trait_matrix <- read.csv("data/Frugivores/response_trait_matrix_frug_Aug2022.csv")
...
saveRDS(study_list_all, "data/Frugivores/results_list_TPDs_trait_weighted_frugivores.rds")

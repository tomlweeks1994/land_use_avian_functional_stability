...
results_list <- readRDS("Datasets/Aug2022/Invertivores/results_list_TPDs_abundance_weighted_invertivores.rds") 
...
write.csv(analysis_data, "Datasets/Aug2022/Invertivores/invertivore_resistance_abundance.csv")

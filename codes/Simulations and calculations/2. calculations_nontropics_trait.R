...
results_list <- readRDS("data/Tropics & non-tropics/simulations_trait_temperate.rds") 
...
write.csv(analysis_data, "data/Tropics & non-tropics/nontropics_all_results_trait.csv")

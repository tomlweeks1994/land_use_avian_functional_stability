...
results_list <- readRDS("data/Tropics & non-tropics/simulations_trait_tropics.rds") 
...
write.csv(analysis_data, "data/Tropics & non-tropics/tropics_all_results_trait.csv")

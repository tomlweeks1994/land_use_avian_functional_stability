...
diversity <- readRDS("data/Invertivores/diversity_combined_sites_Aug2022_inv.rds")
com_matrix_all <- read.csv("data/Invertivores/com_matrix_all_combined_studies_inv_Aug2022.csv")
...
effect_trait_matrix <- read.csv("data/Invertivores/PCA_and_diet_data_Aug2022_inv.csv")
...
response_trait_matrix <- read.csv("data/Invertivores/response_trait_matrix_inv_Aug2022.csv")
...
saveRDS(study_list_all, "data/Invertivores/results_list_TPDs_trait_weighted_invertivores.rds")

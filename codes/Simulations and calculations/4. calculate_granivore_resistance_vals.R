...
results_list <- readRDS("Datasets/Aug2022/Granivores/results_list_TPDs_trait_weighted_granivores.rds") 
...
write.csv(analysis_data, "Datasets/Aug2022/Granivores/graniv_resistance_trait.csv")

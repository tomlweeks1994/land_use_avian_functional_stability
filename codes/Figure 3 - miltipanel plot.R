...
frug_results_tw <- read.csv("data/frug_resistance_trait.csv") %>%
  dplyr::select(SSBS, Resistance_spline, Red, FRich) %>% fix_NAs()

inv_results_tw <- read.csv("data/inv_resistance_trait.csv") %>%
  dplyr::select(SSBS, Resistance_spline, Red, FRich) %>% fix_NAs()

omni_results_tw <- read.csv("data/omniv_resistance_trait.csv") %>%
  dplyr::select(SSBS, Resistance_spline, Red, FRich) %>% fix_NAs()

gran_results_tw <- read.csv("data/graniv_resistance_trait.csv") %>%
  dplyr::select(SSBS, Resistance_spline, Red, FRich) %>% fix_NAs()

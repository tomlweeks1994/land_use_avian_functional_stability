...
### For the Tropics
cov_metrics_trop <- read.csv("data/covariance_metrics_tropics.R")
all_red_frich <- read.csv("data/analysis_data_trait_full.csv")

analysis_data <- left_join(cov_metrics_trop, all_red_rich, by = "SSBS")
...
#######################  Temperate  ###################################
cov_metrics_non_trop <- read.csv("data/covariance_metrics_non_tropics.R")
all_red_frich <- read.csv("data/analysis_data_trait_full.csv")

analysis_data <- left_join(cov_metrics_non_trop, all_red_rich, by = "SSBS")
